...
PWfreq4$Status <- NULL
PWfreq4 <- as.data.frame(t(PWfreq4))
colnames(PWfreq4) <- c("Total", "Controls.", "Cases.", "Controls", "Cases")
...
better <- rep(c("Total",(rep(c("Cases", "Controls"),2))),4)
...
all_freq%>%
  ...
  add_header_above(c(" "= 1, "Polynesian Wide"= 5, "West Polynesian" = 5, "East Polynesian" = 5, "Ngati Porou Hauora" = 5)) %>% 
...
metascoresBMI[1:5,3] <- resultmatrixADP$estimate_adj[2:6]
metascoresBMI[1:3,4] <- resultmatrixNPH$estimate_adj[2:4]
...
metascoresBMI[6:10,3] <- resultmatrixADP$std.error_adj[2:6]
metascoresBMI[6:8,4] <- resultmatrixNPH$std.error_adj[2:4]
